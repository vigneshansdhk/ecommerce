           ...
           <div class="col-md-12">
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                       <input type="hidden" name="ids" wire:model="coupon_id">
                       <div class="form-horizontal">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-4">
                                   <input type="submit" value="Update" name="" Placeholder="Category "class="btn btn-primary pull-center" wire:click="update()" >
                               </div>
                           </div>
                       </div>
                   </div>
