								...
								<li class="product-item">
									<div class="product product-widget-style">
										<div class="thumbnnail">
											<a href="{{url('products',['slug'=>$p_products->slug])}}" title="{{$p_products->name}}">
												<figure><img src="{{asset('assets/images/products')}}/{{$p_products->image}}" alt="{{$p_products->name}}"></figure>
											</a>
										</div>
										<div class="product-info">
											<a href="{{url('products',['slug'=>$p_products->slug])}}" class="product-name"><span>{{$p_products->name}}</span></a>
                              ...
                              @foreach($related_products as $r_products)
								<div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="{{url('products',['slug'=>$r_products->slug])}}" title="{{$r_products->name}}">
